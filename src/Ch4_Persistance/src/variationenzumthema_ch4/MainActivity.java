...
public class MainActivity extends Activity {
	...
	private static final String TITLE = "Chapter 4";

	private final String[] activityNames = { "Resource", "Asset", "SharedPreferences", "InternalStorage",
			"ExternalStorage", "Database", "ORM" };
