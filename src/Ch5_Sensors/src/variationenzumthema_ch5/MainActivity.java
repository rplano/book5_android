...
public class MainActivity extends Activity {
	...
	private static final String TITLE = "Chapter 5";

	private final String[] activityNames = { "Location", "ListSensors", "Environmental", "Motion", "Filter",
			"SensorFusion", "StepCounter" };
