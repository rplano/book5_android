...
public class MainActivity extends Activity {
	...
	private static final String TITLE = "Special Topics 4";

	private final String[] activityNames = { "Hash", "Checksum", "CryptoHash", "CaesarCipher", "XORCipher",
			"SymmetricEncryption", "PassPhraseEncryption", "DiffieHellman", "AsymmetricEncryption", "DigitalSignature",
			"HashCash" };
