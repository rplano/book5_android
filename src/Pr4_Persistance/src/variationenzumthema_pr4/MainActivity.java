...
public class MainActivity extends Activity {
	...
	private static final String TITLE = "Projects 4";

	private final String[] activityNames = { "SpellChecker", "RhymeHelper", "Languages", "UniversalTranslator",
			"Subway", "Synonyms", "Painting", "HelpPages", "Editor", "CalendarSearch", "MusicSearch", "ContactsSearch",
			"ContactsExport", "HexEditor" };
