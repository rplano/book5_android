...
public class MainActivity extends Activity {
	...
	private static final String TITLE = "Projects 8";

	private final String[] activityNames = { "TuneGenerator", "Piano", "WaveformGenerator", "AudioFilter", "Loudness",
			"SnoringService", "Equalizer", "AudioRecorder", "Echo", "Sonar", "Morse", "FlappyBall", "PianoTuning",
			"Spectrogram", "SoundWave", "TakePhoto", "Camera2Preview", "FaceDetection", "Distance", "Camera360",
			"AugmentedReality", "SurveillanceService", "TextReader", "AudioBookCreator", "ChatBot", "Dictation", "IPCam" };
