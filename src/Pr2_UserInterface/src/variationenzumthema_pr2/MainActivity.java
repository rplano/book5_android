...
public class MainActivity extends Activity {
	...
	private static final String TITLE = "Projects 2";

	private final String[] activityNames = { "Lottery", "Blackjack", "CreditCard", "WordGuess", "FahrenheitToCelsius",
			"Quiz", "Wildbienen", "Terminal", "TicTacToe", "Widgets", "IconMenu", "Settings", "FileExplorer",
			"CrosswordPuzzle" };
