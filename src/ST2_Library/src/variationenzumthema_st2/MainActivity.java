...
public class MainActivity extends Activity {
	...
	private static final String TITLE = "Special Topics 2";

	private final String[] activityNames = { "HelloWorld", "BeatingGOval", "FireWorksCleanAntiFreezeActivity",
			"TicTacToe", "MinesClone", "GrayImage", "SlidingPuzzle", "GeometryRun", "Tree", "ConnectTheClicks",
			"BattleShip", "FlappyBall", "Asteroids", "Hexagon", "SpeedRace", "AnimatedPacman", "CityAtNight", "Tetris",
			"TrafficLight", "TwinkleTwinkle", "Confetti", "MouseTracker", "Builder", "Billiards",
			"BrickBreakerProgram" };
				...
				public void onClick(View v) {
					try {
						...
						Intent i = new Intent(getApplicationContext(),
								Class.forName(this.getClass().getPackage().getName() + "." + classNameOfButton));
						startActivity(i);
