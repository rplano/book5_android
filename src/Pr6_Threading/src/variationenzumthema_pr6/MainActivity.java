...
public class MainActivity extends Activity {
	...
	private static final String TITLE = "Projects 6";

	private final String[] activityNames = { "AlarmClock", "SpeedReader", "Confetti", "SnowFlake", "FireWorks",
			"FireWorksClean", "FireWorksCleanAntiFreeze", "RaceHorse", "MandelbrotSuperFast", "HeatMap" };
