...
public class MainActivity extends Activity {
	...
	private static final String TITLE = "Projects 5";

	private final String[] activityNames = { "OpenStreetMap", "EasterEggHunt", "Battery", "EarthQuake", "Age",
			"HauDenLukas", "Billiards", "BrickBreaker", "BubbleLevel", "AllAccelGyro", "RandomGenerator", "Compass",
			"MetalDetector", "Spy", "RotationVectorDemo" };
