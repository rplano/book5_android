...
public class MainActivity extends Activity {
	...
	private static final String TITLE = "Special Topics 3";

	private final String[] activityNames = { "SimpleService", "MusicService", "StepCounterService",
			"StepCounterBinderService", "TemperatureService", "WhoStoleMyPhone" };
