 ...
 * drawing and distributes the load among several threads.s
 * 
...
public class MandelbrotSuperFastActivity extends Activity {
	...
	class MandelbrotView extends View {
		...
		final int NR_OF_THREADS = 16;
		boolean[] isDone = new boolean[NR_OF_THREADS];
		int[][] bitMapArray2;
		...
		public void onDraw(Canvas canvas) {
			...
			for (int i = 0; i < NR_OF_THREADS; i++) {
				ConnectionTask connectionTask1 = new ConnectionTask(i, bitMapArray2[i]);
			...
			// bitmap.setPixels(bitMapArray2a, 0, mCanvasWidth, 0, 0,
			// mCanvasWidth, mCanvasHeight/2);
			// bitmap.setPixels(bitMapArray2b, 0, mCanvasWidth, 0,
			// mCanvasHeight/2, mCanvasWidth, mCanvasHeight/2);
			// bitmap.setPixels(bitMapArray2[0], 0, mCanvasWidth, 0, 0,
			// mCanvasWidth, mCanvasHeight/2);
			// bitmap.setPixels(bitMapArray2[1], 0, mCanvasWidth, 0,
			// mCanvasHeight/2, mCanvasWidth, mCanvasHeight/2);
		...
		class ConnectionTask extends AsyncTask<Double, Void, Long> {
			private int myIndex = -1;
			private int[] bitMapArray;

			public ConnectionTask(int indx, int[] bitMapArray) {
				this.myIndex = indx;
