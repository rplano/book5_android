...
public class MainActivity extends Activity {
	...
	private static final String TITLE = "Chapter 2";

	private final String[] activityNames = { "Button", "Dialog", "About", "Menu", "BorderLayout", "ScreenDimensions",
			"AlarmClock", "Calculator", "Quotes", "Tabs" };
